...
import ru.qWins.dto.MessageConfig;
            ...
            BukkitRunnable task = new BukkitRunnable() {
                ...
                public void run() {
                    ...
                    for (String line : config.getText()) {
                        TextComponent lineComponent = new TextComponent(TextComponent.fromLegacyText(ColorUtil.color(line)));
                    ...
                    if (!config.getHover().isEmpty()) {
                        ...
                        for (String hoverLine : config.getHover()) {
                            hoverBuilder.append(TextComponent.fromLegacyText(ColorUtil.color(hoverLine)));
                            hoverBuilder.append("\n");
                        }
                    ...
                    if (!config.getSound().isEmpty()) {
                        try {
                            Sound sound = Sound.valueOf(config.getSound().replace("minecraft:", "").toUpperCase());
                            for (Player player : Bukkit.getOnlinePlayers()) {
